...
/* package Prover-0.1.0.0 */
#ifndef VERSION_Prover
#define VERSION_Prover "0.1.0.0"
#endif /* VERSION_Prover */
#ifndef MIN_VERSION_Prover
#define MIN_VERSION_Prover(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Prover */
...
#define CURRENT_COMPONENT_ID "Prover-0.1.0.0-inplace-Prover"
